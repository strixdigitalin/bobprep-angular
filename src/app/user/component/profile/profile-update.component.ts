import { MyCertificateComponent } from './../my-certificate-modal/my-certificate.component';
import { MyCourseService } from './../../../shared/services/my-course.service';
import { CountryService } from './../../../shared/services/country.service';
import { ISubject, IMySubject, IMyCourse } from './../../interface';
...
export class ProfileUpdateComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.myCourseService.search({ isCompleted: true, sort: 'completedAt', sortType: 'desc' }).then(resp => {
  ...
  viewCertificate(myCourse: any) {
    ...
    modalRef.componentInstance.appConfig = this._config;
  }
