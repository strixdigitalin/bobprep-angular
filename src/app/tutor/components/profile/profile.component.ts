...
import { SeoService, LanguageService, WebinarService, AuthService, CourseService } from '../../../shared/services';
...
export class TutorProfileComponent implements OnInit, AfterViewInit {
  ...
  queryCourse() {
    ...
    this.courseService
      .search(params)
      .then(resp => {
        this.countCourse = resp.data.count;
